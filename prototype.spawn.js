...
StructureSpawn.prototype.createUpgrader =
    function (working) {
        return this.spawnCreep([WORK, CARRY, MOVE], 'upgrader_' + Game.time, {memory: { role: 'upgrader', working: working}});
    };

// upgrader function
StructureSpawn.prototype.createBuilder =
    function (working) {
        return this.spawnCreep([WORK, CARRY, MOVE], 'builder_' + Game.time, {memory: { role: 'builder', working: working}});
    };
